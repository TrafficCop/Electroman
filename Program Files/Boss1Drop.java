...
/**
 * Write a description of class Boss1Drop here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Boss1Drop extends Drops
{
    GifImage heart = new GifImage("RoBossDrop.gif");
    /**
    ...
    public void changeLevels(){
        ...
        {
            Greenfoot.setWorld(new BossLevel2(Player.getHealth()));
